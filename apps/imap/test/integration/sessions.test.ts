...
const AUTH_CAPS =
  'IMAP4rev1 IMAP4rev2 LITERAL- SASL-IR ID ENABLE NAMESPACE UNSELECT UIDPLUS MOVE CHILDREN LIST-EXTENDED LIST-STATUS SPECIAL-USE ESEARCH SEARCHRES BINARY STATUS=SIZE UTF8=ACCEPT IDLE CONDSTORE QRESYNC';
