...
function scoresOf(signals: Signals): Record<string, number> {
  return {
    ...
    transactional: signals.transactional.value ? 1 : 0,
    transactionalCues: signals.transactional.shape.transactionalScore,
    personalCues: signals.transactional.shape.personalScore,
