# fuzz/proxy-protocol/fixtures

Regression fixtures for the proxy-protocol fuzz target. Each file here is a byte-for-byte crasher input that
once made `fuzz/proxy-protocol/target.mjs` throw something other than its documented error class, hang, or
