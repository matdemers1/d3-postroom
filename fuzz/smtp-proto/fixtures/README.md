# fuzz/smtp-proto/fixtures

Regression fixtures for the smtp-proto fuzz target. Each file here is a byte-for-byte crasher input that
once made `fuzz/smtp-proto/target.mjs` throw something other than its documented error class, hang, or
