...
Regression fixtures for the mime fuzz target. Each file here is a byte-for-byte crasher input that
once made `fuzz/mime/target.mjs` throw something other than its documented error class, hang, or
