# fuzz/attachments/fixtures

Regression fixtures for the attachments fuzz target. Each file here is a byte-for-byte crasher input that
once made `fuzz/attachments/target.mjs` throw something other than its documented error class, hang, or
